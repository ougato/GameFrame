(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/Core/Manager/Event/ViewEvent.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'eca1c64IgFERamd4InYwUpi', 'ViewEvent', __filename);
// Script/Core/Manager/Event/ViewEvent.js
...
var ViewEvent = cc.Class({
    ...
    _register2: function _register2(script, msgIdList) {
        for (var i = 0; i < msgIdList.length; ++i) {
            var scriptNode = new EventNode(script);
